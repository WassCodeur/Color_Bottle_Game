...
export type { ColorBotleGame } from "./contracts/ColorBotleGame";
export { ColorBotleGame__factory } from "./factories/contracts/ColorBotleGame__factory";
export type { ERC20Token } from "./contracts/ERC20Token";
export { ERC20Token__factory } from "./factories/contracts/ERC20Token__factory";
export type { MyAirdrop } from "./contracts/MyAirdrop";
export { MyAirdrop__factory } from "./factories/contracts/MyAirdrop__factory";
